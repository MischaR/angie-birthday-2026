# Our Story – Content Reference

> Edit this file to update the birthday site content. Each section maps to `index.html`.

---

## Hero Section

**Title:** Happy Birthday, mi cielita ❤️

**Subtitle:** Celebrating you with love and joy
...
**Note:** Replace the YouTube video ID in `index.html` (currently `dQw4w9WgXcQ` placeholder).
...
### Item 2: Arriving in Germany (2021)
...
### Item 9: Colombia Trip (March 2024)
...
**Instruction:** What do you need for your next adventure?
